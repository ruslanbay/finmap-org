...
export class CanvasRenderer {
  ...
  private renderNodeText(node: any, width: number, height: number, isLeaf: boolean, change: number, context: CanvasRenderingContext2D): void {
    context.save();
  ...
  private drawWrappedText(text: string, x: number, y: number, maxWidth: number, lineHeight: number, maxLines: number, context: CanvasRenderingContext2D): number {
