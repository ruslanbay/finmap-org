...
import type { Exchange, ChartData } from '../src/types/index.js';
...
async function testDataServices(): Promise<ChartData | null> {
  ...
  try {
    ...
    console.log(`✅ Data processing: created chart data with ${String(chartData.securities.length)} securities`);
